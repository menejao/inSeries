...
function printSummary(label: string, summary: Awaited<ReturnType<typeof syncExistingSeriesDetails>>) {
  console.log(`\n${label}`);
...
async function main() {
  ...
  printSummary("Sync de detalhes de series existentes concluido.", summary);
