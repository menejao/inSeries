...
test("Meu calendario e Todos os lancamentos alternam via tab sem sair da rota", async ({ page, request }) => {
...
test("periodo Hoje/Semana/Mes do calendario global funciona", async ({ page, request }) => {
  await registerViaApi(request);
