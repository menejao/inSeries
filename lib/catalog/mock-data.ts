...
export const mockSeries: Series[] = [
  {
    ...
    userState: "WATCHING",
    qualityScore: 88,
    collectionTags: ["Premiada", "Sci-Fi"],
    watchProviders: ["Apple TV+"],
    keywords: ["dystopia", "workplace"],
    type: "Scripted",
    logoUrl: null,
    originCountry: ["US"],
    spokenLanguages: ["Ingles"],
    createdBy: ["Dan Erickson"],
    networks: ["Apple TV+"],
    productionCompanies: ["Fifth Season"],
    productionCountries: ["Estados Unidos"],
    tagline: "Bem-vindo a Lumon.",
    homepage: null,
    seasons: [
      {
        id: "ruptura-s1",
  ...
  },
  {
    ...
    qualityScore: 75,
    collectionTags: ["Premiada", "Drama"],
    watchProviders: ["Disney+"],
    keywords: ["chef", "restaurant"],
    type: "Scripted",
    logoUrl: null,
    originCountry: ["US"],
    spokenLanguages: ["Ingles"],
    createdBy: ["Christopher Storer"],
    networks: ["FX"],
  ...
  },
  {
    ...
    userState: "COMPLETED",
    qualityScore: 82,
    collectionTags: ["Premiada", "Mistério", "Longa Duração"],
    watchProviders: ["Netflix"],
    keywords: ["time travel", "small town"],
    type: "Scripted",
    logoUrl: null,
    originCountry: ["DE"],
    spokenLanguages: ["Alemao"],
    createdBy: ["Baran bo Odar", "Jantje Friese"],
    networks: ["Netflix"],
    productionCompanies: ["Wiedemann & Berg Television"],
    productionCountries: ["Alemanha"],
    tagline: null,
    homepage: null,
    seasons: []
  }
